...
export default function GameContent() {
    ...
    return (
        <div className="grid grid-cols-12 h-[calc(100vh-3.75rem)]">
            ...
            <div id="backTooltip" className="flex flex-col justify-between gap-6 self-start mt-6 mx-2 w-20 lg:w-24 h-[calc(100%-5rem)]">
            ...
            h-[calc(100vh-3.75rem)] scale-90 -mt-2">
                ...
                {/* game notif */}
                <div className={`absolute top-[10%] w-full text-center text-2xs lg:text-xs`}>
                    <GameNotif />
                </div>
            </section>
