...
export default function GameContent() {
    ...
    return (
        <div className="grid grid-cols-12 h-[calc(100vh-3.75rem)]">
            ...
            flex flex-col gap-6 self-start mt-6 mx-2 w-20 lg:w-24 h-[calc(100%-5rem)]`}>
                ...
                {/* tutorial button */}
                <div data-tooltip="tutorial" className="w-6 lg:w-8">
                ...
                <GameInfo />
                {/* game history */}
                <div ref={gameHistoryRef} className={`text-2xs lg:text-xs
