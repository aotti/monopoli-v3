...
export default function GameButtons() {
    ...
    return (
        <form className="relative z-10 flex flex-col gap-2 lg:gap-3 mx-auto w-fit px-2 text-center animate-fade animate-delay-400" 
        onSubmit={ev => manageFormSubmits(ev, miscState, gameState)}>
            {/* username + laps */}
