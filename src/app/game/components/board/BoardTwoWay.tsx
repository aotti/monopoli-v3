    ...
    return (
        <>
            ...
            <div className="flex">
                ...
                {/* 3 */}
                <div className={`border w-[7.5vw] h-[15.5vh] ${squareNumberStyle}`} data-square="16a">
                    <img src="" alt="" className="bg-darkblue-1 w-[7.5vw] h-[15.5vh]" draggable={false} />
                </div>
                {/* 4 */}
                <div className="w-[7.5vw] h-[15.5vh]"></div>
            ...
            <div className="flex">
                ...
                {/* 2 */}
                <div className={`border w-[7.5vw] h-[15.5vh] ${squareNumberStyle}`} data-square="14a">
                    <img src="" alt="" className="bg-darkblue-1 w-[7.5vw] h-[15.5vh]" draggable={false} />
                </div>
                {/* 3 */}
                <div className={`border w-[7.5vw] h-[15.5vh] ${squareNumberStyle}`} data-square="15a">
                    <img src="" alt="" className="bg-darkblue-1 w-[7.5vw] h-[15.5vh]" draggable={false} />
                </div>
                {/* 4 */}
                <div className="w-[7.5vw] h-[15.5vh]"></div>
            ...
            <div className="flex">
                ...
                <div className="w-[7.5vw] h-[15.5vh]"></div>
                {/* 8 */}
                <div className={`border w-[7.5vw] h-[15.5vh] ${squareNumberStyle}`} data-square="1a">
                    <img src="" alt="" className="bg-darkblue-1 w-[7.5vw] h-[15.5vh]" draggable={false} />
                </div>
                {/* 9 */}
                <div className={`border w-[7.5vw] h-[15.5vh] ${squareNumberStyle}`} data-square="28a">
                    <img src="" alt="" className="bg-darkblue-1 w-[7.5vw] h-[15.5vh]" draggable={false} />
                </div>
                {/* 10 */}
            ...
            <div className="flex">
                ...
                <div className="w-[7.5vw] h-[15.5vh]"></div>
                {/* 8 */}
                <div className={`border w-[7.5vw] h-[15.5vh] ${squareNumberStyle}`} data-square="2a">
                    <img src="" alt="" className="bg-darkblue-1 w-[7.5vw] h-[15.5vh]" draggable={false} />
                </div>
                {/* 9 */}
                <div className="w-[7.5vw] h-[15.5vh]"></div>
