...
export default function TutorialGameRoom() {
    ...
    const tutorialText = {
        ...
        part_2: [
            ...
            `all tiles have tooltip. city tooltip changes after bought. other tiles only show static info, except for prison tile. it updates your dice accumulation. the 🔍 icon to see full image of tiles.`
        ],
        part_3: [
            ...
            `idk y its position bugged in tutorial 💀`,
        ]
    }
    ...
    return (
        <>
            ...
            absolute top-[5%] lg:top-[15%] right-16 lg:right-20 w-3/4 lg:w-2/5`}>
                {/* help */}
            ...
            flex-col gap-[17.5vh] lg:gap-[15vh] absolute z-10 top-14 md:top-16 lg:top-28 left-[calc(25%-1rem)] w-[calc(50%+2rem)] 
