        ...
        w-[14vw] ${gameState.showGameHistory ? 'h-[55vh]' : 'h-[5vh]'} bg-darkblue-1 border-2`}>
            ...
            <div id="history_container" className="flex flex-col gap-2 w-full h-[47vh] overflow-y-scroll scrollbar-none p-1">
                {gameState.gameHistory.map((v,i) => {
                    ...
                    // check card content
                    const checkHistoryContent1 = historyContent.match(/lose money,move place|special card|more money|get money|lose money|move place|move forward|move backward|take card|destroy property|upgrade city|sell city/) || ''
